            ...
            <div className=" relative mb-5 md:text-6xl   text-5xl lg:text-[100px] font-bold uppercase gap-5">
              <div className="flex gap-x-3 justify-center text_style items-center relative ">
                ...
                <div className="relative">
                  ...
                  <span className="absolute md:top-[15px] md:right-0 lg:-top-2 right-3  h-2 w-16 rounded-xl border-white bg-gradient-to-r from-[#7cf535] to-[#2bdfbc]"></span>
                </div>
              ...
              <div className="absolute md:top-[40%] lg:right-[-280px] lg:h-44 lg:w-72 w-28 lg:top-[40%] top-[90%] h-16 -right-10 rounded-3xl box_shadow  border-white bg-gradient-to-r from-[#7cf535] to-[#2bdfbc] -rotate-45">
